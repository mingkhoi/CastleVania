...
#define money_lv2_gravity 650.0f

class moneyLv2 : public gameObjectEx
{
public:
	moneyLv2(int id)
		: gameObjectEx(id) {
		this->assignAnimationSet("money_lv2");
		this->setSizeItem("moneyLv2");
	}
	...
	virtual void update(float dt) {
		this->speed_y += money_lv2_gravity * dt;
